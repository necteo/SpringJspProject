...
<body>
	...
	<div class="container" id="list_app" style="margin-top: 30px">
	  <div class="row">
	  	<div class="col-md-3" v-for="(vo, idx) in store.list" :key="idx">
		    <div class="thumbnail">
	  ...
	  <div class="row text-center" style="margin-top: 10px">
	  	<ul class="pagination">
	  		...
	  		<li v-for="i in store.range" :class="i == store.curpage ? 'active' : ''">
	  			<a class="nav-link" @click="store.movePage(i)">{{i}}</a>
	  		</li>
